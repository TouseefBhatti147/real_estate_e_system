...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Add New Member</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Add New Member" />
              ...
              <div class="col-md-12">
                <div class="card card-success mb-4">
                  <div class="card-header">
                    <h3 class="card-title mb-0">Enter Member Details</h3>
                  </div>
                  <!-- /.card-header -->
                  <form action="" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="memberName" name="memberName" placeholder="Enter Full Name" required>
                      </div>

                      <div class="mb-3">
                        <label for="memberFatherSpouse" class="form-label">Father/Spouse Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="memberFatherSpouse" name="memberFatherSpouse" placeholder="Enter Father's or Spouse's Name" required>
                      </div>

                      <div class="mb-3">
                        <label for="memberCNIC" class="form-label">CNIC <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="memberCNIC" name="memberCNIC" placeholder="Enter CNIC (e.g., 12345-6789012-3)" required>
                      </div>

                      <div class="mb-3">
                        <label for="memberAddress" class="form-label">Address <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="memberAddress" name="memberAddress" rows="3" placeholder="Enter Full Postal Address" required></textarea>
                      </div>
                      ...
                      <!-- Fields for Username/Password -->
                       <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="memberUsername" name="memberUsername" placeholder="Enter Username" required>
                      </div>

                       <div class="mb-3">
                        <label for="memberPassword" class="form-label">Password <span class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="memberPassword" name="memberPassword" placeholder="Enter Password" required>
                      </div>

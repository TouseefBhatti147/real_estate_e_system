...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Add Upcoming Project</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Add Upcoming Project" />
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Add Upcoming Project</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="projects_upcomming.php">Upcoming Project List</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add Upcoming Project</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h3 class="card-title mb-0">Add New Upcoming Project</h3>
                  </div>
                  <div class="card-body">
                    <form action="#" method="post" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="projectUrl" placeholder="Enter Project URL" required>
                      </div>
                      <div class="mb-3">
                        <label for="teaser" class="form-label">Teaser <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="teaser" placeholder="Enter Teaser Text" required>
                      </div>
                      <div class="mb-3">
                        <label for="projectDetail" class="form-label">Project Detail <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="projectDetail" rows="3" placeholder="Enter Project Details" required></textarea>
                      </div>
                      <div class="mb-3">
                        <label for="projectImages" class="form-label">Select Images <span class="text-danger">*</span></label>
                        <input class="form-control" type="file" id="projectImages" multiple required>
                      </div>
                       <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="projectMap" required>
                      </div>
                    </form>
                  </div>
                  <!-- /.card-body -->

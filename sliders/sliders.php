...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Slider List</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Slider List" />
              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header d-flex align-items-center">
                    ...
                    <a href="add_slider.php" class="btn btn-success ms-auto">Add Slider</a>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><!-- Link was not provided --></td>
                                <td>
                                    <a href="update_slider.php?id=2" class="btn btn-sm btn-warning me-1"><i class="bi bi-pencil-square"></i></a>

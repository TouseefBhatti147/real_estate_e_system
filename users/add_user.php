...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Add User</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Add User" />
              ...
              <div class="col-md-12">
                <div class="card card-success mb-4">
                  <div class="card-header">
                    <h3 class="card-title mb-0">Enter User Details</h3>
                  </div>
                  <!-- /.card-header -->
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                         <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control" id="so_do_wo" name="so_do_wo" required>
                        </div>
                        <div class="col-md-4 mb-3">
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-3">
                           ...
                           <select class="form-select" id="officeLocation" name="officeLocation" required>
                                ...
                                <option value="Head Office,Islamabad">Head Office,Islamabad</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check-group" style="max-height: 300px; overflow-y: auto; padding: 10px; border: 1px solid #ced4da; border-radius: .25rem;">
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="PER1" id="perm1">
                                  <label class="form-check-label" for="perm1">Add/Remove User/Setting (PER1)</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="PER2" id="perm2">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="PER3" id="perm3">
                        ...
                        <div class="col-md-6">
                            <h6>Projects Permission</h6>
                             <div class="form-check-group" style="padding: 10px; border: 1px solid #ced4da; border-radius: .25rem;">
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="proj_multan" id="proj1">
                                  <label class="form-check-label" for="proj1">Royal Orchard Multan</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="proj_multan_2" id="proj2">
                                  <label class="form-check-label" for="proj2">Royal Orchard-II, Multan</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="proj_sargodha" id="proj3">
                                  <label class="form-check-label" for="proj3">Royal Orchard Sargodha</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="proj_sahiwal" id="proj4">

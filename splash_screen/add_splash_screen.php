...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Add Splash Screen</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Add Splash Screen" />
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Add Splash Screen</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item"><a href="splash_screen.php">Splash Screen List</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add Splash Screen</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="card card-primary mb-4">
                  <div class="card-header">
                    <h3 class="card-title mb-0">New Splash Screen Details</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->

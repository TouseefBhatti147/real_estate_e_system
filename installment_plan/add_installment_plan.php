...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Add Installment Plan</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Add Installment Plan" />
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0">Add Installment Plan</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item"><a href="installment_plan.php">Installment Plan List</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add Installment Plan</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="card card-primary mb-4">
                  <div class="card-header">
                    <h3 class="card-title mb-0">New Installment Plan Details</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="" method="POST">
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" id="planDescription" name="planDescription" rows="3" placeholder="Enter plan description..." required></textarea>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="totalInstallments" name="totalInstallments" placeholder="e.g., 36" value="0" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                           <div class="mb-3">
                            <label for="totalAmount" class="form-label">Total Amount <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="totalAmount" name="totalAmount" placeholder="e.g., 4500000" step="0.01" value="0" required>
                          </div>
                        </div>
                      </div>

...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Update Bank</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Update Bank" />
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Update Bank</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h3 class="card-title mb-0">Update Bank Details</h3>
                  </div>
                  <div class="card-body">
                    <form action="#" method="post">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="bankName" value="Askari - Multan" required>
                      </div>
                      <div class="mb-3">
                        <label for="bankCode" class="form-label">Code <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="bankCode" value="Askari" required>
                      </div>
                      <div class="mb-3">

...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Real Estate E-system - Banks List</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes" />
    <meta name="color-scheme" content="light dark" />
    <meta name="theme-color" content="#007bff" media="(prefers-color-scheme: light)" />
    <meta name="theme-color" content="#1a1a1a" media="(prefers-color-scheme: dark)" />
    <meta name="title" content="Admin | Banks List" />
              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header d-flex align-items-center">
                    ...
                    <a href="add_bank.php" class="btn btn-success ms-auto">Add Bank</a>
                  </div>
                  <div class="card-body">
                     <div class="row mb-3">
                      <div class="col-md-4">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>-</td>
                          <td>
                            <a href="update_bank.php" class="btn btn-sm btn-warning me-1"><i class="bi bi-pencil-square"></i></a>
